  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Container(
          alignment: Alignment.centerLeft,
          margin: const EdgeInsets.only(top: 30.0, left: 55.0),
          child: const Text(
            'Gym',
            style: TextStyle(
                fontSize: 23.0,
          ...
          return Container(
              ...
              child: Obx(
                () => ListView.separated(
                  ...
                  itemCount: Get.find<GymTaskControllers>().task.length,
                  itemBuilder: (context, index) {
                    return Obx(() => ListTile(
                          ...
                          onLongPress: () {
                            Get.defaultDialog(
                              title:
                                  'Delete ${Get.find<GymTaskControllers>().task[index].title}',
                          ...
                          title: Text(Get.find<GymTaskControllers>()
                              .task[index]
                              .title!),
                          subtitle: Text(Get.find<GymTaskControllers>()
                              .task[index]
                              .subtitle!),
                          onTap: () {
                            Get.find<GymTaskControllers>().index = index;
                            ...
                            onChanged: (value) {
                              Get.find<GymTaskControllers>()
                                  ...
                                  !Get.find<GymTaskControllers>()
                                      .task[index]
                                      .status!;
                              Get.find<GymTaskControllers>().task[index] =
                                  Get.find<GymTaskControllers>().task[index];
                            },
                            value: Get.find<GymTaskControllers>()
                                .task[index]
                                .status,
        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              Container(
                alignment: Alignment.centerLeft,
                margin: const EdgeInsets.only(top: 5.0, left: 98.0),
                child: const Text(
                  'GYM',
                  style: TextStyle(
                      fontSize: 23.0,
