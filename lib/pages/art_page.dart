          ...
          return Container(
              ...
              child: Obx(
                () => ListView.separated(
                  ...
                  itemCount: Get.find<ArtTaskControllers>().task.length,
                  itemBuilder: (context, index) {
                    return Obx(() => ListTile(
                          ...
                          onLongPress: () {
                            Get.defaultDialog(
                              title:
                                  'Delete ${Get.find<ArtTaskControllers>().task[index].title}',
                          ...
                          title: Text(Get.find<ArtTaskControllers>()
                              .task[index]
                              .title!),
                          subtitle: Text(Get.find<ArtTaskControllers>()
                              .task[index]
                              .subtitle!),
                          onTap: () {
                            Get.find<ArtTaskControllers>().index = index;
                            Get.find<ArtTaskControllers>().isediting.value =
                                true;
                            ...
                            onChanged: (value) {
                              Get.find<ArtTaskControllers>()
                                  ...
                                  !Get.find<ArtTaskControllers>()
                                      .task[index]
                                      .status!;
                              Get.find<ArtTaskControllers>().task[index] =
                                  Get.find<ArtTaskControllers>().task[index];
                            },
                            value: Get.find<ArtTaskControllers>()
                                .task[index]
                                .status,
        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              Container(
                alignment: Alignment.centerLeft,
                margin: const EdgeInsets.only(top: 5.0, left: 100.0),
                child: const Text(
                  'ART',
                  style: TextStyle(
                      fontSize: 23.0,
