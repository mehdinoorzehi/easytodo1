          ...
          return Container(
              ...
              child: Obx(
                () => ListView.separated(
                  ...
                  itemCount: Get.find<StudyTaskControllers>().task.length,
                  itemBuilder: (context, index) {
                    return Obx(() => ListTile(
                          ...
                          onLongPress: () {
                            Get.defaultDialog(
                              title:
                                  'Delete ${Get.find<StudyTaskControllers>().task[index].title}',
                          ...
                          title: Text(Get.find<StudyTaskControllers>()
                              .task[index]
                              .title!),
                          subtitle: Text(Get.find<StudyTaskControllers>()
                              .task[index]
                              .subtitle!),
                          onTap: () {
                            Get.find<StudyTaskControllers>().index = index;
                            ...
                            onChanged: (value) {
                              Get.find<StudyTaskControllers>()
                                  ...
                                  !Get.find<StudyTaskControllers>()
                                      .task[index]
                                      .status!;
                              Get.find<StudyTaskControllers>().task[index] =
                                  Get.find<StudyTaskControllers>().task[index];
                            },
                            value: Get.find<StudyTaskControllers>()
                                .task[index]
                                .status,
        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              Container(
                alignment: Alignment.centerLeft,
                margin: const EdgeInsets.only(top: 5.0, left: 87.0),
                child: const Text(
                  'STUDY',
                  style: TextStyle(
                      fontSize: 23.0,
