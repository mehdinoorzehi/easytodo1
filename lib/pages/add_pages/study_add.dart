          ...
          child: Column(
            children: [
              ...
              AddButton(
                ...
                text: studyController.isediting.value ? 'Edit' : 'Add',
                onTap: () {
                  String text = textController.title!.text;
                  if (text.isEmpty) {
                    Get.snackbar('ERROR', 'Please enter some text',
                        backgroundColor: KPurpleColor);
                  } else if (studyController.isediting.value) {
                    var task = studyController.task[studyController.index];
                    //
                    task.title = textController.title!.text;
                    task.subtitle = textController.subtitle!.text;
                    //
                    studyController.task[studyController.index] = task;
                    Get.back();
                  } else {
                    studyController.task.add(
                      StudyTaskModels(
