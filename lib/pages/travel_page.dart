                  ...
                  itemBuilder: (context, index) {
                    return Obx(() => ListTile(
                          ...
                          onLongPress: () {
                            Get.defaultDialog(
                              title:
                                  'Delete ${Get.find<TravelTaskControllers>().task[index].title}',
                          ...
                          title: Text(Get.find<TravelTaskControllers>()
                              .task[index]
                              .title!),
                          subtitle: Text(Get.find<TravelTaskControllers>()
                              .task[index]
                              .subtitle!),
                          onTap: () {
        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              Container(
                alignment: Alignment.centerLeft,
                margin: const EdgeInsets.only(top: 5.0, left: 80.0),
                child: const Text(
                  'TRAVEL',
                  style: TextStyle(
                      fontSize: 23.0,
