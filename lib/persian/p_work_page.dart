...
class pWorkPage extends StatelessWidget {
  const pWorkPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Container(
          alignment: Alignment.centerLeft,
          margin: const EdgeInsets.only(top: 20.0, left: 57.0),
          child: const Text(
            'کاری',
            style: TextStyle(
                fontSize: 23.0,
          ...
          return Container(
              ...
              child: Obx(
                () => ListView.separated(
                  ...
                  itemCount: Get.find<WorkTaskControllers>().task.length,
                  itemBuilder: (context, index) {
                    return Obx(() => ListTile(
                          ...
                          onLongPress: () {
                            Get.defaultDialog(
                              title:
                                  'حذف ${Get.find<WorkTaskControllers>().task[index].title}',
                              titleStyle:
                          ...
                          onTap: () {
                            Get.find<WorkTaskControllers>().index = index;
                            ...
                            onChanged: (value) {
                              Get.find<WorkTaskControllers>()
                                  ...
                                  !Get.find<WorkTaskControllers>()
                                      .task[index]
                                      .status!;
                              Get.find<WorkTaskControllers>().task[index] =
                                  Get.find<WorkTaskControllers>().task[index];
                            },
                            value: Get.find<WorkTaskControllers>()
                                .task[index]
                                .status,
