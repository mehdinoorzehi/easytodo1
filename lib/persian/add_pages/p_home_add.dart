...
class pHomeAddPage extends StatelessWidget {
  const pHomeAddPage({super.key});
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: () {
          ...
          if (text.isEmpty) {
          ...
          } else if (Get.find<HomeTaskControllers>().isediting.value) {
            var task = Get.find<HomeTaskControllers>()
                .task[Get.find<HomeTaskControllers>().index];
            //
            ...
            Get.find<HomeTaskControllers>()
                .task[Get.find<HomeTaskControllers>().index] = task;
            Get.back();
          } else {
            Get.find<HomeTaskControllers>().task.add(
                  HomeTaskModels(
        ...
        child: Text(Get.find<HomeTaskControllers>().isediting.value
            ? 'ویرایش'
            : 'اضافه کردن'),
      ),
    );
