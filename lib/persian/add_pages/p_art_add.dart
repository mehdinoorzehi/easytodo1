...
class pArtAddPage extends StatelessWidget {
  const pArtAddPage({super.key});
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: () {
          ...
          if (text.isEmpty) {
          ...
          } else if (Get.find<ArtTaskControllers>().isediting.value) {
            var task = Get.find<ArtTaskControllers>()
                .task[Get.find<ArtTaskControllers>().index];
            //
            ...
            Get.find<ArtTaskControllers>()
                .task[Get.find<ArtTaskControllers>().index] = task;
            Get.back();
          } else {
            Get.find<ArtTaskControllers>().task.add(
                  ArtTaskModels(
        ...
        child: Text(Get.find<ArtTaskControllers>().isediting.value
            ? 'ویرایش'
            : 'اضافه کردن'),
      ),
    );
