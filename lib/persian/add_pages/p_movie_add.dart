...
class pMovieAddPage extends StatelessWidget {
  const pMovieAddPage({super.key});
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: () {
          ...
          if (text.isEmpty) {
          ...
          } else if (Get.find<MovieTaskControllers>().isediting.value) {
            var task = Get.find<MovieTaskControllers>()
                .task[Get.find<MovieTaskControllers>().index];
            //
            ...
            Get.find<MovieTaskControllers>()
                .task[Get.find<MovieTaskControllers>().index] = task;
            Get.back();
          } else {
            Get.find<MovieTaskControllers>().task.add(
                  MovieTaskModels(
        ...
        style: TextButton.styleFrom(backgroundColor: KGreenColor),
        child: Text(Get.find<MovieTaskControllers>().isediting.value
            ? 'ویرایش'
            : 'اضافه کردن'),
      ),
    );
