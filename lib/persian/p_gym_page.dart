...
class pgymPage extends StatelessWidget {
  const pgymPage({super.key});
                  ...
                  itemBuilder: (context, index) {
                    return Obx(() => ListTile(
                          ...
                          onLongPress: () {
                            Get.defaultDialog(
                              title:
                                  'حذف ${Get.find<GymTaskControllers>().task[index].title}',
                              titleStyle:
        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              Container(
                alignment: Alignment.centerLeft,
                margin: const EdgeInsets.only(top: 5.0, left: 96.0),
                child: const Text(
                  'باشگاه',
                  style: TextStyle(
                      fontSize: 23.0,
